...
function get20s(arr){
  var iteratingBirthYear;
  var iteratingDeathYear;
  var result = new Array();
  for (var i in arr){
    iteratingBirthYear = parseInt(arr[i].years.substring(0,4));
    iteratingDeathYear = parseInt(arr[i].years.substring(7,11));
    console.log(iteratingDeathYear);
    if (iteratingBirthYear >= 1900 && iteratingDeathYear <= 2000){
